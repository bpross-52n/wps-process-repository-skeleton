 ...
 */
package org.n52.wps.python.data;
...
public class DataTypeRegistry {
    ...
    private static Logger LOGGER = LoggerFactory.getLogger(DataTypeRegistry.class);
     ...
     * @throws PythonAnnotationException if an invalid key was passed
     */
    public RTypeDefinition getType(String key) throws PythonAnnotationException {
        ...
        if (out == null) {
            throw new PythonAnnotationException("Invalid datatype key for R script annotations: " + key);
        }
