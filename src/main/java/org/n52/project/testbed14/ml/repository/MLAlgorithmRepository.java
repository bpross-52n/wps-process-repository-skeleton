 ...
 */
package org.n52.project.testbed14.ml.repository;
...
import org.n52.geoprocessing.project.testbed14.ml.Train_MLDecisionTreeClassificationAlgorithm;
 ...
 *
 */
public class MLAlgorithmRepository implements
...
//            return algorithmMap.get(className);
    ...
    private IAlgorithm loadAlgorithm(String algorithmClassName)
            throws Exception {
        Class<?> algorithmClass = MLAlgorithmRepository.class
